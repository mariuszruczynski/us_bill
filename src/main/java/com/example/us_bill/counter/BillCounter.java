package com.example.us_bill.counter;
...
public class BillCounter {
    ...
    public void countBill(List<BillPosition> billPositions, Bill bill) {
        ...
        BigDecimal shipingCostInZl = (shipingCost.multiply(dolarCost)).divide(BigDecimal.valueOf(billPositions.size()), 2, RoundingMode.FLOOR);
